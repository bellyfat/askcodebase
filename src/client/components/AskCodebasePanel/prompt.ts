...
- An <div class="askcode"> always follows an <askcmd> but can be optional if there's no code changes needed. This is because the instructions dictate the path for code insertion or modification.
...
- Avoid plain code generated. Double check and make sure code after <askcmd> is wrapped inside <div class="askcode"> tags with an 'id' attribute and 'class' attribute should inlcude language-[lang].
---
